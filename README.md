...
**eduOSGeoSeoul**은 [OSGeo(Open Source Geospatial Foundation) 한국지부](https://osgeo.kr/)에서 제공하는 오픈소스 공간정보(OSSGIS) 기술 교육을 위한 실습 기반 지무 교육 저장소입니다.
...
- **Docker Desktop**: 컨테이너 기반으로 서버 환경 실행
- **QGIS**: 공간 데이터 확인 및 가공
